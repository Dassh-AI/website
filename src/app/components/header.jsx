...
const Header = () =>{
  ...
  return (
    <Disclosure as="nav" style={{backgroundColor:"#063A3A"}}>
      <div className="mx-auto max-w-8xl px-2 sm:px-6 lg:px-10">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div style={{color:"#CBDCBD",fontWeight:500}} className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  />
                <ChevronDownIcon aria-hidden="true" className='h-7 w-7 ml-2 '/> 
                </MenuButton>
              </div>
              <MenuItems
                transition
